class DateHandler {
    ...
    createPreviousDateData(maxDateArray,minDateArray){
        let date = [];
        const nowTime = new Date();
        let maxYear =  nowTime.getFullYear();
        let maxMonth = nowTime.getMonth();
        let maxDay = nowTime.getDate();
        ...
        minYear =  minDateArray ? minDateArray[0] : 1960
        minMonth = minDateArray ? minDateArray[1] : maxMonth
                ...
                for(let j = 1;j < maxMonth + 1;j++){
                    ...
                    if (j == maxMonth + 1) {
                        if(j === 2){
                            ...
                            for(let k=maxDay;k<32;k++){
                                day.push(k+'日');
                            }
                        }else{
                            for(let k=maxDay;k<31;k++){
                                day.push(k+'日');
                            }
                        }
                    }else{
